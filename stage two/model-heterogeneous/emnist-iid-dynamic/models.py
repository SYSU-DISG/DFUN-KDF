...
class cifar_CNN_3layer_fc_model_removelogsoftmax(nn.Module):
    def __init__(self):
        super(cifar_CNN_3layer_fc_model_removelogsoftmax, self).__init__()
