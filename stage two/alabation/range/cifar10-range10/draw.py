...
window_size = 10
# 读取JSON文件
with open('cifar10-iid-range10.json', 'r') as file:
    data1 = json.load(file)
with open('cifar10-iid-range30.json', 'r') as file:
    data2 = json.load(file)
with open('cifar10-iid-dynamic.json', 'r') as file:
    data3 = json.load(file)
with open('cifar10-iid-range70.json', 'r') as file:
...
#将data存为.json格式的文件
with open('cifar-range.json', 'w') as file:
    json.dump(data, file)
