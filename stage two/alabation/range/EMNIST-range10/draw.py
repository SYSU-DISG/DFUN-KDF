...
window_size = 10
# 读取JSON文件
with open('emnist-iid-range10.json', 'r') as file:
    data1 = json.load(file)
with open('emnist-iid-range30.json', 'r') as file:
    data2 = json.load(file)
with open('emnist-iid-static.json', 'r') as file:
    data3 = json.load(file)
with open('emnist-iid-range70.json', 'r') as file:
...
#将data存为.json格式的文件
with open('emnist-range.json', 'w') as file:
    json.dump(data, file)
