...
window_size = 10
# 读取JSON文件
with open('emnist-iid-5client.json', 'r') as file:
    data1 = json.load(file)
with open('emnist-iid-static.json', 'r') as file:
    data2 = json.load(file)
with open('emnist-iid-20client.json', 'r') as file:
    data3 = json.load(file)
with open('emnist-iid-40client.json', 'r') as file:
...
#将data存为.json格式的文件
with open('emnist-clients.json', 'w') as file:
    json.dump(data, file)
