...
def main():
    ...
    for round in range (0,num_rounds):
        ...
        for i in range(0, 3):
            client_trainer[i].client_model = CNN_3layer_fc_model_removelogsoftmax()
            client_trainer[i].client_model.to(device)
            client_model, acc_list = client_trainer[i].fake_train(num_epochs)
        ...
        for i in range (3,client_number):
    ...
    file_path = "Fedavg-emnist-static-malicious3.json"
