...
for i in range(0, 10):
    model_client = cifar_CNN_3layer_fc_model_removelogsoftmax()
...
for epoch in range(num_epochs):
    ...
    # 保存每个模型
for model_idx, model in enumerate(models):
    save_path = f'C:/Users/mrlazy/Desktop/实验文件/FedMD复现/model/cifar10_model_{model_idx + 1}_pretrain_{epoch + 1}.pt'
