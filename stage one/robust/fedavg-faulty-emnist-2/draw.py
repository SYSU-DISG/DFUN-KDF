...
# 读取JSON文件
with open('Fedavg-emnist-faulty-2.json', 'r') as file:
    data1 = json.load(file)
with open('Fedavg-emnist-faulty-3.json', 'r') as file:
    data2 = json.load(file)
with open('Fedavg-emnist-faulty-4.json', 'r') as file:
...
for i in range(0,8):
    print(data1[str(i)][-1])
for i in range(0,7):
    print(data2[str(i)][-1]*0.99)
for i in range(0,6):
    print(data3[str(i)][-1]*0.98)
