...
window_size = 10
# 读取JSON文件
with open('iid-5client-1.json', 'r') as file:
    data1 = json.load(file)
with open('iid-10client-1.json', 'r') as file:
    data2 = json.load(file)
with open('iid-20client-1.json', 'r') as file:
    data3 = json.load(file)
with open('iid-40client-1.json', 'r') as file:
...
#将data存为.json格式的文件
with open('iid-connectivity.json', 'w') as file:
    json.dump(data, file)
